...
/* Fichier1 : fichier d'entrée contenant les choix des binomes
   Fichier2 : fichier contenant la liste de tout les projets */
  ...
  else
  {
    ...
    else
    {
      ...
      if (optimstatus == GRB_OPTIMAL) 
      {
        ...
        printf("\nVoici les affectations (choix = -1 : le projet ne fait pas parti de leur choix):\n");
        for (i = 0; i < taille; i++)
        {
          if (sol[i] == 1) 
          {
